...
```
g++ -std=c++17 -I../Empirical/include main.cc -o hello
```
...
In this case, our population is going to be represented as a `vector` (a kind of C++-style array) of floating point numbers.
...
We will iterate forward through generations, each one creating a new population based on the previous population.
